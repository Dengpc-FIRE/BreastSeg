...
DEFAULT_CONFIG = PROJECT_ROOT / "configs" / "kpta_25d_net_headneck_dce_56ch.yaml"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Test KPTA on HeadNeckDCE.")
...
def main() -> int:
    ...
    with torch.inference_mode():
        for images, masks, names in tqdm(loader, desc="KPTA HeadNeckDCE test"):
    ...
    output_dir = Path(args.output_dir or (Path(train_cfg["output_path"]) / "test_headneck_dce"))
